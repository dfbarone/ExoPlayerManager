...
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.ACTION_VIEW_LIST;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.AD_TAG_URI_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.DRM_KEY_REQUEST_PROPERTIES_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.DRM_LICENSE_URL_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.DRM_MULTI_SESSION_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.DRM_SCHEME_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.DRM_SCHEME_UUID_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.EXTENSION_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.IS_LIVE_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.SUBTITLE_LANGUAGE_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.SUBTITLE_MIME_TYPE_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.SUBTITLE_URI_EXTRA;
import static com.dfbarone.android.exoplayer2.manager.SimpleExoPlayerManager.URI_EXTRA;
...
public abstract class Sample {
  ...
  public static class UriSample extends Sample {
    ...
    public void addToIntent(Intent intent) {
      intent.setAction(SimpleExoPlayerManager.ACTION_VIEW).setData(uri);
      intent.putExtra(SimpleExoPlayerManager.IS_LIVE_EXTRA, isLive);
      intent.putExtra(SimpleExoPlayerManager.SPHERICAL_STEREO_MODE_EXTRA, sphericalStereoMode);
      addPlayerConfigToIntent(intent, /* extrasKeySuffix= */ "");
    }

    public void addToPlaylistIntent(Intent intent, String extrasKeySuffix) {
      intent.putExtra(SimpleExoPlayerManager.URI_EXTRA + extrasKeySuffix, uri.toString());
      intent.putExtra(SimpleExoPlayerManager.IS_LIVE_EXTRA + extrasKeySuffix, isLive);
      addPlayerConfigToIntent(intent, extrasKeySuffix);
    }
  ...
  public static class PlaylistSample extends Sample {
    ...
    @Override
    public void addToIntent(Intent intent) {
      intent.setAction(SimpleExoPlayerManager.ACTION_VIEW_LIST);
